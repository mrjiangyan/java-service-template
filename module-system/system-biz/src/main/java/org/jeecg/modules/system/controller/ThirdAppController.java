...
//        if (thirdAppConfig.isWechatEnterpriseEnabled()) {
//            SyncInfoVo syncInfo = wechatEnterpriseService.syncLocalDepartmentToThirdApp();
//            if (syncInfo.getFailInfo().size() == 0) {
...
//        if (thirdAppConfig.isWechatEnterpriseEnabled()) {
//            SyncInfoVo syncInfo = wechatEnterpriseService.syncThirdAppDepartmentToLocal();
//            if (syncInfo.getFailInfo().size() == 0) {
//                return Result.OK("同步成功", syncInfo);
//            } else {
//                return Result.error("同步失败", syncInfo);
...
//            SyncInfoVo syncInfo = dingtalkService.syncLocalDepartmentToThirdApp();
//            if (syncInfo.getFailInfo().size() == 0) {
//                return Result.OK("同步成功", null);
//            } else {
//                return Result.error("同步失败", syncInfo);
...
//        if (thirdAppConfig.isDingtalkEnabled()) {
//            SyncInfoVo syncInfo = dingtalkService.syncThirdAppDepartmentToLocal();
//            if (syncInfo.getFailInfo().size() == 0) {
//                return Result.OK("同步成功", syncInfo);
//            } else {
//                return Result.error("同步失败", syncInfo);
