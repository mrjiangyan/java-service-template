...
//        }
    ...
    public String getDepartIdsByOrgCode(@RequestParam(DEPART_KEY_ORG_CODE)String orgCode){
    ...
    List<Map> getDeptUserByOrgCode(@RequestParam(DEPART_KEY_ORG_CODE)String orgCode){
