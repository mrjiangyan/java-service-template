...
import static org.jeecg.common.constant.CommonConstant.DEPART_KEY_ORG_CODE;
...
public class SysUserController {
    ...
    public Result<IPage<SysUser>> queryPageList(SysUser user,@RequestParam(name="pageNo", defaultValue="1") Integer pageNo,
        ...
        if(req.getParameterMap().containsKey("username")){
            queryWrapper.like(SysUser::getUsername,req.getParameterMap().get("username")[0]);
        }
    ...
    public Result<?> queryByDepartId(
            @RequestParam(name = "pageNo", defaultValue = "1") Integer pageNo,
            @RequestParam(name = "pageSize", defaultValue = "10") Integer pageSize,
            @RequestParam(name = DEPART_KEY_ORG_CODE) String orgCode,
            SysUser userParams
    ) {
    ...
    public Result<?> queryByOrgCodeForAddressList(
            @RequestParam(name = "pageNo", defaultValue = "1") Integer pageNo,
            @RequestParam(name = "pageSize", defaultValue = "10") Integer pageSize,
            @RequestParam(name = DEPART_KEY_ORG_CODE,required = false) String orgCode,
            SysUser userParams
    ) {
...
//                json.put("avatar", item.getSysUser().getAvatar());
    ...
    public Result<Map<String,Object>> getCurrentUserDeparts() {
        ...
        try {
            ...
            map.put("list", list);
            map.put(DEPART_KEY_ORG_CODE, sysUser.getOrgCode());
            result.setSuccess(true);
